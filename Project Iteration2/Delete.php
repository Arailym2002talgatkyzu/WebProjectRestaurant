...
<div class="container">
    ...
    <div class="slider">
        <div class="title">
            ...
            <a href="contact.php"><p class="btn">SIGN UP </p></a>
        </div>
    </div>

    <form class = 'reg-form' method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
        <h1 style="text-align: center; background-color: black; color: white; font-size: 50px; font-family: Gabriola; ">Deleting User</h1>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(isset($_POST['uname'])){
            $sql="DELETE FROM followers WHERE username='$uname'";
        }
        if($conn->query($sql)==TRUE){
            echo "IT SUCCESSFULLY DELETED";
        }
        else{
            echo "THERE OCCURRED ERROR";
        }
        if($conn->query($sql)==TRUE){
    ...
    <div class="footer">
        <br> <a>Telephone:87718038463</a></br>
        <a>Email:a.bakhazatkahnova@astanaitedu.kz</a>
    </div>
</div>
</form>
</body>
